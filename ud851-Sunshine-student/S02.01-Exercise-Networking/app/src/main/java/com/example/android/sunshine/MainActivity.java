...
//        }
    ...
    private void loadWeatherData() {
        URL searchUrl = NetworkUtils.buildUrl("HeZe");
        new performNetworkRequestsTask().execute(searchUrl);
    }

    private class performNetworkRequestsTask extends AsyncTask<URL, Void, String> {
